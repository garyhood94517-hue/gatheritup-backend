...
app.post('/api/export', authRequired, async (req, res) => {
  try {
    ...
    emailBody += `<p style="color:#374151;font-size:15px;margin:0 0 16px;line-height:1.7;">Hi ${user.first_name},</p>`
    emailBody += `<p style="color:#374151;font-size:15px;margin:0 0 24px;line-height:1.7;">As per your request, here is your personal copy of your Q${quarter} ${year} memories. <strong>This email is your story</strong> — it includes the story behind each memory and the individual caption for every photo and video. Your download links are included below each photo and video.</p>`
